...
Analog zu den PHP-Beispielen erhalten Sie hier dieselben Funktionen auf
Basis von Python.

Über die einzelnen Menüpunkte gelangen Sie zu den jeweiligen Inhalten
und können diese mit den PHP-Beispielen vergleichen.


Portalabfrage
-------------

Analog zu dem PHP-Beispiel für die Portalabfrage erfolgt hier die
Nutzung mit Hilfe von Python.
...
### Setting headers for CortexUniplexWebAPI
headers = {
    'Accept': 'application/json',
    'Content-Type': 'application/json'
}

### data object to request the user login for the CortexUniplexWebAPI
data = { 
    "method" :  "getLogin",
    "requestid" : requestID,
    "param" : {
...
Python-Beispiel mit Klasse
--------------------------

``` 
'''
A Python library for working with CortexUniplexWebAPI
